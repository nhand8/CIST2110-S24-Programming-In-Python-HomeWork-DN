...
fav_foods = ["Sushi", "Fries", "Quesadillas", "Steak", "Burritos"]
print(fav_foods)
...
for food in reversed(fav_foods):
    print(food)
...
def reverse_list(list):
    return list[::-1]
print(reverse_list(fav_foods)) # ['Burritos', 'Steak', 'Quesadillas', 'Fries', 'Sushi']
print(reverse_list(list)) # [[7, 8, 9], [4, 5, 6], [1, 2, 3]]